        ...
        <!-- Image slider -->
            ...
            <div class="swiper h-screen w-full">
                ...
                <div class="swiper-wrapper mt-1">
                    <!-- Slides -->
                    <div class="swiper-slide"><img class="object-center object-cover w-full" src="application/views/image/slider1.jpg" alt=""></div>
                    <div class="swiper-slide"><img class="object-center object-cover w-full" src="application/views/image/slider2.jpg" alt=""></div>
                    <div class="swiper-slide"><img class="object-center object-cover w-full" src="application/views/image/slider3.jpg" alt=""></div>
                    <div class="swiper-slide"><img class="object-center object-cover w-full" src="application/views/image/slider4.png" alt=""></div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 item text">
                        ...
                        <p>Computer science (CS) is the study of computers and algorithmic processes, including their principles, their hardware and software designs, their applications, and their impact on society.</p>
                    </div>
